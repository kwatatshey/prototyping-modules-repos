...
resource "aws_eip" "nat_gw_elastic_ip" {
  ...
  tags = {
    Name = "${var.resource_prefix}-${var.environment}-${var.app_name}-nat-eip"
  }
}
...
module "vpc" {
  ...
  name = "${var.resource_prefix}-${var.environment}-${var.app_name}-vpc"
  ...
  tags = {
    "kubernetes.io/cluster/${var.resource_prefix}-${var.environment}-${var.app_name}-${var.cluster_name}" = "shared"
  }
  public_subnet_tags = {
    "kubernetes.io/cluster/${var.resource_prefix}-${var.environment}-${var.app_name}-${var.cluster_name}" = "shared"
    # "kubernetes.io/role/elb"
    "kubernetes.io/role/elb"  = 1
    "karpeneter.sh/discovery" = local.public
